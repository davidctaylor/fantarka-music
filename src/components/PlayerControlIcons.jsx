...
export const AboutIcon = (props) => (
  <div className='player-sc-footer-about' style={{width: 30, height: 30}} onClick={(evt) => props.handleOnClick(evt, 'about')}>
    <svg style={{width: 30, height: 30}} x="0px" y="0px" viewBox='0 0 487.65 487.65'>
      <g>
        <path
